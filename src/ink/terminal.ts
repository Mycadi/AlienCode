...
export function writeDiffToTerminal(
  ...
  // NUI/MINIMAL: old conhost (Win10 1607) can't parse DEC 2026 at all —
  // the unknown private-mode CSI leaks partial characters on every frame.
  const useSync = !skipSyncMarkers && !(process.env.CLAUDE_CODE_MINIMAL || process.env.CLAUDE_CODE_NUI)
