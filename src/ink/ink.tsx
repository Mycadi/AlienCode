...
export default class Ink {
  ...
  exitAlternateScreen(): void {
    ...
    this.options.stdout.write((!(process.env.CLAUDE_CODE_MINIMAL || process.env.CLAUDE_CODE_NUI) ? '\x1b[?1004h' : '') + (supportsExtendedKeys() ? DISABLE_KITTY_KEYBOARD + ENABLE_KITTY_KEYBOARD + ENABLE_MODIFY_OTHER_KEYS : ''));
  }
  onRender() {
