...
import { WARN } from '../../utils/nuiChars.js';
...
4. **Choose the model** — Default to \`claude-sonnet-4-8\`. Tell the user which model you're defaulting to and ask if they want a different one.
