...
import { TREE_END, ARROW_R } from '../utils/nuiChars.js';
...
function _temp4(warning, i_0) {
  return <Box key={`warning-${i_0}`} flexDirection="column"><Box><Text dimColor={true}>{`${TREE_END} `}</Text><Text color="warning">[Warning]</Text><Text dimColor={true}> {warning.message}</Text></Box>{warning.suggestion && <Box marginLeft={3}><Text dimColor={true}>{`${ARROW_R} `}{warning.suggestion}</Text></Box>}</Box>;
}
function _temp3(error, i) {
  return <Box key={`error-${i}`} flexDirection="column"><Box><Text dimColor={true}>{`${TREE_END} `}</Text><Text color="error">[Error]</Text><Text dimColor={true}> {error.message}</Text></Box>{error.suggestion && <Box marginLeft={3}><Text dimColor={true}>{`${ARROW_R} `}{error.suggestion}</Text></Box>}</Box>;
}
function _temp2(w_0) {
