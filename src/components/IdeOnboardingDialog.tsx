...
import { IDE_LINK, STAR_AST } from '../utils/nuiChars.js';
...
export function IdeOnboardingDialog(t0) {
  ...
  if ($[7] === Symbol.for("react.memo_cache_sentinel")) {
    t5 = <Text color="claude">{STAR_AST} </Text>;
    $[7] = t5;
  } else {
    t5 = $[7];
  }
  ...
  if ($[10] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text color="suggestion">{IDE_LINK} open files</Text>;
    $[10] = t8;
  } else {
    t8 = $[10];
  }
  ...
  if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
    t9 = <Text>• Claude has context of {t8}{" "}and <Text color="suggestion">{IDE_LINK} selected lines</Text></Text>;
    $[11] = t9;
  } else {
    t9 = $[11];
  }
