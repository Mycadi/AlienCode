...
export function IdeStatusIndicator(t0) {
  ...
  if (ideSelection.text && ideSelection.lineCount > 0) {
    ...
    if ($[0] !== ideSelection.lineCount || $[1] !== t1) {
      t2 = <Text color="ide" key="selection-indicator" wrap="truncate">{IDE_LINK} {ideSelection.lineCount}{" "}{t1} selected</Text>;
  ...
  if (ideSelection.filePath) {
    ...
    let t2;
    if ($[5] !== t1) {
      t2 = <Text color="ide" key="selection-indicator" wrap="truncate">{IDE_LINK} In {t1}</Text>;
      $[5] = t1;
      $[6] = t2;
    } else {
      t2 = $[6];
