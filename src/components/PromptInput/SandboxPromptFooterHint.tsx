...
import { SANDBOX } from '../../utils/nuiChars.js';
export function SandboxPromptFooterHint() {
  ...
  if ($[2] !== detailsShortcut || $[3] !== recentViolationCount || $[4] !== t2) {
    t3 = <Box paddingX={0} paddingY={0}><Text color="inactive" wrap="truncate">{SANDBOX} Sandbox blocked {recentViolationCount}{" "}{t2} ·{" "}{detailsShortcut} for details · /sandbox to disable</Text></Box>;
    $[2] = detailsShortcut;
