...
import { CHECK, CROSS, WARN } from '../utils/nuiChars.js';
  ...
  return <Box flexDirection="row" gap={1}>
      ...
      {isUpdating ? <Box>
          <Text dimColor wrap="truncate">
            ...
            {CHECK} Update installed · Restart to update
          </Text>}
      {autoUpdaterResult?.status === 'install_failed' && <Text color="error" wrap="truncate">
          {CROSS} Auto-update failed &middot; Try <Text bold>/status</Text>
        </Text>}
      {maxVersionIssue && "external" === 'ant' && <Text color="warning">
          {WARN} Known issue: {maxVersionIssue} &middot; Run{' '}
