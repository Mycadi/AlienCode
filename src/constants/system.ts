...
const DEFAULT_PREFIX = `You are Alien Code, a command-line AI coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Alien Code, a command-line AI coding assistant, running within the Claude Agent SDK.`
