...
export async function maybeResizeAndDownsampleImageBuffer(
  ...
  try {
    ...
    // Always allow the image through when sharp fails — let the API handle
    // size/dimension rejection with a proper error message rather than
    // blocking the paste operation client-side.
